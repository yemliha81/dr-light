            ...
            <div class="row">
                <div class="col-lg-12 m-t-10">
                    <span class="page_title">
						<i class="fa fa-list"></i> Govde Rengi Listesi
					</span>
                </div>
							...
							<tbody>
								<?php foreach($variants as $variant){ ?>
									<tr>
										...
										<td class="text-right">
											<a href="<?php echo UPDATE_GOVDE.$variant['id'];?>" class="btn btn-xs btn-info">
												<i class='fa fa-pencil' ></i>
											</a>
											<a href="<?php echo DELETE_GOVDE.$variant['id'];?>" class="btn btn-xs btn-danger">
